...
class DataAdmission extends Model
{
    ...
    'data_year', 'data_major', 'data_gpax', 'data_email','data_phone', 'admission_name', 
    'round_name', 'admission_id','data_admission_file_name', 'data_admission_file', 'data_keep_file_name'
    ];
